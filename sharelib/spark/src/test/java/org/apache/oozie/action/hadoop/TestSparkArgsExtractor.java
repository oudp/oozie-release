    ...
    public void testPropertiesFileMerging() throws Exception {
        ...
        assertEquals("Spark args mismatch",
                Lists.newArrayList("--master", "yarn", "--deploy-mode", "client", "--name", "Spark Copy File",
                        ...
                        "spark.yarn.security.tokens.hiveserver2.enabled=false", "--conf",
                        "spark.yarn.security.tokens.hivestreaming.enabled=false", "--conf", "spark.yarn.security.tokens.hbase.enabled=false",
