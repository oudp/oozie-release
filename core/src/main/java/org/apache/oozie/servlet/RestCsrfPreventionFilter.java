...
public class RestCsrfPreventionFilter implements Filter {
    ...
    private static final String CUSTOM_METHODS_TO_IGNORE_PARAM =
            "methods-to-ignore";
    private static final String  BROWSER_USER_AGENTS_DEFAULT = "^Mozilla.*,^Opera.*";
    private static final String HEADER_DEFAULT = "X-XSRF-HEADER";
    private static final String  METHODS_TO_IGNORE_DEFAULT = "GET,OPTIONS,HEAD,TRACE";
    private static final String OOZIE_CSRF_COOKIE_NAME = "OOZIE-CSRF-TOKEN";
